...
<html lang="en">
	<head>
		...
		<meta name="description" content="desafioDitech" />
			...
			<div class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-inner">
					<div class="container">
						...
						<a class="brand" href="./">desafioDitech</a>
						<div class="nav-collapse collapse">
							<ul class="nav">
								...
								<?php } ?>
								<li <?php if ($this->nav=='agendas') { echo 'class="active"'; } ?>><a href="./indexOld.php">Agendas</a></li>
								<li <?php if ($this->nav=='salas') { echo 'class="active"'; } ?>><a href="./salas">Salas</a></li>
								<li <?php if ($this->nav=='suspensoeses') { echo 'class="active"'; } ?>><a href="./suspensoeses">Suspensoeses</a></li>
