...
var page = {
	...
	updateModel: function() {
		...
		page.usuario.save({
			...
			'aniversario': $('input#aniversario').val(),
			'dataDeCadastro': $('input#dataDeCadastro').val()+' '+$('input#dataDeCadastro-time').val(),
			'apelido': $('input#apelido').val(),
			'empresa': $('input#empresa').val(),
			'observacoes': $('input#observacoes').val(),
			'endereco': $('input#endereco').val(),
			'email': $('input#email').val(),
			'fone': $('input#fone').val(),
			'fone1': $('input#fone1').val(),
			'fone2': $('input#fone2').val(),
