...
require_once("DAO/SuspensoesCriteriaDAO.php");

/**
 * The SuspensoesCriteria class extends SuspensoesDAOCriteria and is used
 ...
 * @version 1.0
 */
class SuspensoesCriteria extends SuspensoesCriteriaDAO
{
