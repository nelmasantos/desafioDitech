...
GlobalConfig::$CONNECTION_SETTING->DBName = "salareuniaodb";
...
/** the root url of the application with trailing slash, for example http://localhost/desafioditech/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'desafioDitech/';
